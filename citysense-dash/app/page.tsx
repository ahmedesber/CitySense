  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white p-8 font-sans">
      ...
      <div className="flex justify-between items-end mb-12 border-b border-slate-800 pb-6">
        <div>
          <h1 className="text-5xl font-black tracking-tighter text-blue-500 italic">CITYSENSE</h1>
          <p className="text-slate-400 font-medium tracking-wide">AI-POWERED ROAD MONITORING NODE</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
        ...
        <MetricCard title="Detection Confidence" value="96%" icon={<ShieldCheck className="text-green-500" />} subtitle="Mean Avg Precision" />
        <MetricCard title="5G Edge Latency" value="12ms" icon={<Zap className="text-yellow-500" />} subtitle="End-to-End Pipeline" />
      </div>
      ...
      <div className="relative h-[600px] rounded-[2.5rem] overflow-hidden border border-slate-800 shadow-[0_0_50px_-12px_rgba(59,130,246,0.3)]">
        <Map
          initialViewState={{ longitude: 56.3265, latitude: 25.1288, zoom: 14 }}
        ...
        <div className="absolute top-6 left-6 bg-slate-950/80 backdrop-blur-md border border-slate-800 p-4 rounded-2xl">
          ...
          <div className="flex items-center gap-2">
            ...
            <p className="text-sm font-mono text-white">SYNCED: detections.json</p>
          </div>
        </div>
      </div>
    </main>
